...
public class InicioSesion extends Fragment {
    ...
    public void verificarUsuario(){
        ...
        if(cursor.moveToFirst()){
            Toast.makeText(getActivity().getApplicationContext(),"LOGUEADO",Toast.LENGTH_SHORT);
        }
        else{
            Toast.makeText(getActivity().getApplicationContext(),"NECESITA REGISTRARSE",Toast.LENGTH_SHORT);
        }
